...
const MENU_LINKS: CommandLinkItem[] = [
  ...
  // Removed Blog and Components links since those routes are not present
];
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList className="min-h-80">
          ...
          <CommandGroup heading="Brand Assets">
            ...
            <CommandItem
              onSelect={() => handleOpenLink("/blog/kamoyass-brand")}
            >
              <TriangleDashedIcon />
              Brand Guidelines
            </CommandItem>
  ...
  return (
    <>
      ...
      <div className="absolute inset-x-0 bottom-0 flex h-10 items-center justify-between gap-2 border-t bg-zinc-100/30 px-4 text-xs font-medium dark:bg-zinc-800/30">
        <KamoyassMark className="size-6 text-muted-foreground" aria-hidden />
